...
public sealed class Preset1920X1440 : GenshinImpactCvPreset
{
    #region General

    public override Size Resolution { get; protected set; } = new(1920, 1440);
    #endregion

    #region Search regions
    public override Rectangle SpeakerNameSearchRegion { get; protected set; } = new(935, 1190, 50, 150);
    #endregion

    #region Dialog option
    public override Rectangle DialogOptionSearchRegion { get; protected set; } = new(1266, 210, 63, 1000);
    ...
    #region Utils
    public override Point HiddenCursorLocation { get; protected set; } = new(1915, 1438);
    #endregion
}
